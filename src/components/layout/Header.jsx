      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative ml-2" ref={dropdownRef}>
          <button
            ...
            className="flex items-center gap-3 p-1.5 pr-3 rounded-full border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-900 transition-all"
          >
